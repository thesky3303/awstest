(function () {
  ...
  function renderCurrentSlide() {
    ...
    if (!hero || !rank || !title || !meta || !desc || !cta) return;

    hero.style.backgroundImage = `
      linear-gradient(90deg, rgba(7, 18, 40, 0.82) 0%, rgba(7, 18, 40, 0.62) 35%, rgba(7, 18, 40, 0.35) 60%, rgba(7, 18, 40, 0.18) 100%),
      url('${resolveMainPosterUrl(movie.main_poster_url || movie.poster_url)}')
    `;
